...
export function SiteFooter(){
  return <footer className="site-footer">
    ...
    <nav className="footer-links"><Link href="/menu">Menú</Link><Link href="/reservas">Reservas</Link><Link href="/simijaca">Simijacá</Link><Link href="/politicas">Privacidad</Link></nav>
