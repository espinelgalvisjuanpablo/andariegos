...
export default function Home(){
  ...
  return <main>
    <section className="hero-home"><div className="hero-ornament hero-ornament-a"/><div className="hero-ornament hero-ornament-b"/><div className="hero-copy">
    ...
    </div><p className="hero-signature">ARTESANAL · ARTÍSTICO · ELEGANTE</p></section>

    <section className="section featured-section"><div className="section-heading"><div><p className="eyebrow">{en?"NOW AT ANDARIEGOS":"AHORA EN ANDARIEGOS"}</p><h2>{en?"Featured":"Destacados"}</h2></div><p>{en?"A place to highlight what is happening, what is worth trying or simply what the kitchen wants to share today.":"Un espacio para destacar lo que está pasando, lo que vale la pena probar o simplemente lo que la cocina quiere compartir hoy."}</p></div>
      <div className="featured-grid">
        <article className="feature-card feature-dark"><span>01</span><h3>{en?"A kitchen that travels":"Una cocina que viaja"}</h3><p>{en?"Colombia, Argentina, Peru and Simijacá meet at the same table.":"Colombia, Argentina, Perú y Simijacá se encuentran en una misma mesa."}</p><Link href="/menu">{en?"Explore the menu →":"Explorar el menú →"}</Link></article>
        <article className="feature-card feature-image"><Image src="/images/huerta.jpg" alt="Huerta de Andariegos" fill sizes="(max-width: 800px) 100vw, 50vw"/><div className="image-overlay"><span>02 · HUERTA</span><h3>{en?"From the earth to the kitchen":"De la tierra a la cocina"}</h3></div></article>
        <article className="feature-card feature-paper"><span>03 · PLAN</span><h3>{en?"Before or after eating":"Antes o después de comer"}</h3><p>{en?"If you came to Simijacá, there is still a town to discover.":"Si llegaste a Simijacá, todavía queda pueblo por descubrir."}</p><Link href="/simijaca">{en?"Discover Simijacá →":"Descubrir Simijacá →"}</Link></article>
      </div>
    </section>
